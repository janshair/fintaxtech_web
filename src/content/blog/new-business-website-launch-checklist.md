...
tags: [Website planning, Launch checklist, New businesses]
featuredImage: ../../assets/blog/new-business-website-launch-checklist/new-business-website-launch-checklist-hero.png
imageAlt: Illustration of a website layout, mobile preview and completed launch checklist
draft: false
cta: general
---
...
- Phone number as a clickable `tel:` link, so tapping it dials
- Email address visible as text, not hidden behind a form alone
...
- Readable URLs — `/services/tax-returns`, not `/page?id=47`
- An XML sitemap for a multi-page site, with important pages checked in Google Search Console
