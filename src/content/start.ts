export const startCopy = {
  ...
  privacy:
    'Your answers stay in memory while the questionnaire is open. Closing or reloading it clears them; download the PDF if you want to keep a copy. Preparing an enquiry creates no contract or payment obligation.',
};
